...
export default function CalendarPage() {
    ...
    const [events, setEvents] = useState([
        { id: 1, date: new Date().toDateString(), title: 'Family Dinner' },
        { id: 2, date: new Date(new Date().setDate(new Date().getDate() + 2)).toDateString(), title: 'Grocery Shopping' },
    ]);
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                    ...
                    <Button onClick={() => handleDateClick(new Date())}><Plus size={16} /> Add Event</Button>
                </div>
            </div>
